...
router.patch('/lead/:place_id', async (req, res) => {
  try {
    ...
    const { remarks, highlighted, callHistory, reminderDate, reminderRemark, name, phone, city, telecaller, callStatus, instagram, website, color, archived, pipelineStage } = req.body;
    await updateLead(place_id, { remarks, highlighted, callHistory, reminderDate, reminderRemark, name, phone, city, telecaller, callStatus, instagram, website, color, archived, pipelineStage });
